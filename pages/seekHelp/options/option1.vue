	...
	<view class="box">
		...
		<view class="centreBox" style="min-height:750rpx;">
			<view class="collapse">
				...
				<!-- <u-collapse  >
					<u-collapse-item :title="itemList[0].head"  :open="itemList[0].open" :disabled="itemList[0].disabled"
					 class="itemList">
						
						<u-checkbox-group @change="checkboxGroupChange" >
							<u-checkbox @change="checkboxChange" v-model="itemList[0].list[0].checked" :name="itemList[0].list[0].name" shape="circle" active-color='#FFE300'
							 class="u-checkbox">
								<view class="contain">
									<view class="name">
										{{itemList[0].list[0].name}}
									</view>
								</view>
							</u-checkbox>
						</u-checkbox-group>
